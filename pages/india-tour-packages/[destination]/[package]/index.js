...
export default function IndiaDestinationPage({ data, breadcrumbObj }) {
...
//         alternates: {
//             canonical: `${appBaseURL}india-tour-packages/${params.destination}/${params.package}`,
//         },
//         openGraph: {
//             title: data?.Data?.MetaTitle,
//             description: data?.Data?.MetaDescription,
...
//             url: `${appBaseURL}india-tour-packages/${params.destination}/${params.package}`
//         },
//         twitter: {
