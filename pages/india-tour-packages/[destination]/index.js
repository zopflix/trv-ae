...
export default function IndiaDestinationPage({ data, faqObjs, breadcrumbObj }) {
    ...
    return (
        <Layout>
            ...
            <HolidayListing isDomestic={true} packageData={data} />
        </Layout>
    )
}
...
//         alternates: {
//             canonical: `${appBaseURL}india-tour-packages/${params.destination}`,
//         },
//         openGraph: {
//             title: res?.Data?.MetaTitle,
//             description: res?.Data?.MetaDescription,
...
//             url: `${appBaseURL}india-tour-packages/${params.destination}`
//         },
//         twitter: {
