...
export async function getServerSideProps({ params }) {
    ...
    const breadcrumbObj = {
        ...
        "itemListElement": [{
            ...
            "item": "https://www.travanya.ae/international-tour-packages/"
        }, {
            "@type": "ListItem",
            "position": 3,
            "name": capitalizeEachWord(params.destination.replaceAll('-', ' ')),
            "item": `https://www.travanya.ae/international-tour-packages/${params.destination}/`
        }, {
            "@type": "ListItem",
            "position": 4,
            "name": capitalizeEachWord(params.package.replaceAll('-', ' ')),
            "item": `https://www.travanya.ae/international-tour-packages/${params.destination}/${params.package}/`
        }
        ]
    }
