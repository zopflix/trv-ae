...
function FlightPageChild1(props) {
    ...
    return (
        <Layout>
            <Head>
                ...
                <link rel="canonical" href={`${appBaseURL}${props.data.parent}/${props.data.child1}/`} />
...
export async function getServerSideProps(context) {
    ...
    const data = await getFlightsPageData({ parent: context.params.flights, child1: context.params.child1, tenantId: tenantId });
...
export default FlightPageChild1;
