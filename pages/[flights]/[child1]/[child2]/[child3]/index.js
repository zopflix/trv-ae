    ...
    return (
        <Layout>
            <Head>
                ...
                <link rel="canonical" href={`${appBaseURL}${props.data.parent}/${props.data.child1}/${props.data.child2}/${props.data.child3}/`} />
...
export async function getServerSideProps(context) {
    ...
    const data = await getFlightsPageData({ parent: context.params.flights, child1: context.params.child1, child2: context.params.child2, child3: context.params.child3, tenantId: tenantId });
