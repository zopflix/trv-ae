    ...
    return (
        <Layout>
            <Head>
                ...
                <link rel="canonical" href={`${appBaseURL}${props.data.parent}/${props.data.child1}/${props.data.child2}/${props.data.child3}/${props.data.child4}/${props.data.child5}/${props.data.child6}/${props.data.child7}/`} />
...
export async function getServerSideProps(context) {
    ...
    const data = await getFlightsPageData({ parent: context.params.flights, child1: context.params.child1, child2: context.params.child2, child3: context.params.child3, child4: context.params.child4, child5: context.params.child5, child6: context.params.child6, child7: context.params.child7, tenantId: tenantId });
