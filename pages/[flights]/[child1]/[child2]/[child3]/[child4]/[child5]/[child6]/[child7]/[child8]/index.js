    ...
    return (
        <Layout>
            <Head>
                ...
                <link rel="canonical" href={`${appBaseURL}${props.data.parent}/${props.data.child1}/${props.data.child2}/${props.data.child3}/${props.data.child4}/${props.data.child5}/${props.data.child6}/${props.data.child7}/${props.data.child8}/`} />
...
export async function getServerSideProps(context) {
    ...
    const data = await getFlightsPageData({ parent: context.params.flights, child1: context.params.child1, child2: context.params.child2, child3: context.params.child3, child4: context.params.child4, child5: context.params.child5, child6: context.params.child6, child7: context.params.child7, child8: context.params.child8, tenantId: tenantId });
    ...
    const breadcrumbObj = {
        ...
        "itemListElement": [{
            ...
            "@type": "ListItem",
            "position": 9,
            "name": capitalizeEachWord(context.params.child7.replaceAll('-', ' ')),
            "item": `https://www.travanya.com/${context.params.flights}/${context.params.child1}/${context.params.child2}/${context.params.child3}/${context.params.child4}/${context.params.child5}/${context.params.child6}/${context.params.child7}/`
        }, {
            "@type": "ListItem",
            "position": 10,
            "name": capitalizeEachWord(context.params.child8.replaceAll('-', ' '))
        }]
    }
