...
export async function getServerSideProps(context) {
    ...
    const breadcrumbObj = {
        ...
        "itemListElement": [{
            ...
            "item": `https://www.travanya.ae/${context.params.flights}/${context.params.child1}/${context.params.child2}/${context.params.child3}/${context.params.child4}/${context.params.child5}/${context.params.child6}/${context.params.child7}/`
        }, {
            "@type": "ListItem",
            "position": 10,
