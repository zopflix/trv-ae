                                            ...
                                            <table className="table table-bordered text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{aedNumberFormat(Math.round(bookingData?.contract?.serviceFee)).split('.')[0]}</td>
                                                    </tr>
                                                    <tr>
                                                        <td align='right' colSpan="4"><h5 className='mb-0 fw-bold'>Total Price</h5></td>
                                                        <td><h5 className='mb-0 fw-bold'>{aedNumberFormat(Math.round(bookingData.contract.totalPrice)).split('.')[0]}</h5></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
