            ...
            <form>
              <div className="d-flex">
                <div className="d-flex">
                  ...
                  <div className="ms-2">
                    <label className={tripType == 2 ? "cursor-pointer form-check-label fs-14 bg-orange color-white px-3 py-1 rounded-pill active" : "cursor-pointer form-check-label fs-14 bg-grey px-3 py-1 rounded-pill"} htmlFor="roundtrip1" onClick={() => { setTripType(2); let _date = new Date(fromDate); setToDate(new Date(_date.setDate(_date.getDate() + 3))); }}> Round Trip </label>
                  </div>
                </div>
              </div>
              ...
              <div className="row my-2 text-center align-items-center">
                <div className="col-5 my-2">
                  <span className="fw-bold fs-20">{props.fromCity}</span>
                </div>
                <div className="col-2">
                  <Image
                    className="h-auto"
                ...
                <div className="col-5 my-2">
                  <span className="fw-bold fs-20">{props.toCity}</span>
                </div>
              </div>
              <div className="col-12">
                <div className="row">
                  <div className="col-12">
                    ...
                    <div className="input-group mb-3 d-flex flex-nowrap w-100 position-relative DateBox">
                  ...
                  {tripType == 2 &&
                    <div className="col-12">
                      ...
                      <div className="input-group mb-3 d-flex flex-nowrap w-100 DateBox">
                        <span className="input-group-text bg-transparent border-end-0">
                          <img className="img-fluid" src="https://assets.faremaze.com/fm-bh/calender.svg" alt="calender" />
                        </span>
                        <ReactDatePicker
              ...
              <div className="row">
                <div className="FormGroup mb-2">
                  ...
                  <div className="position-relative">
                    ...
                    <input className={(hasError && !email) || isValidEmail == false ? "form-control border-red" : "form-control"}
                      type="text"
                ...
                <div className="FormGroup mb-2">
                  ...
                  <div className="position-relative">
                    ...
                    <input className={hasError && mobile.length < 10 ? "form-control border-red" : "form-control"}
                      type="text" pattern="[0-9]*" inputMode="numeric" onPaste={(e) => e.preventDefault()} maxLength={10}
