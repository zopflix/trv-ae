                      ...
                      <div className="flip-card-inner">
                        ...
                        <div className="flip-card-back rounded-4">
                          ...
                          <ul className="fs-12 ms-0 ps-3">
                            <li><a className="color-black" href="#">Dubai to Georgia - </a></li>
                            <li><a className="color-black" href="#">Abu Dhabi to Georgia - </a></li>
                            <li><a className="color-black" href="#">Sharjah to Georgia - </a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flip-card">
                      <div className="flip-card-inner">
                        ...
                        <div className="flip-card-back rounded-4">
                          ...
                          <ul className="fs-12 ms-0 ps-3">
                            <li><a className="color-black" href="#">Dubai to Maldives - </a></li>
                            <li><a className="color-black" href="#">Abu Dhabi to Maldives - </a></li>
                            <li><a className="color-black" href="#">Sharjah to Maldives - </a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flip-card">
                      <div className="flip-card-inner">
                        ...
                        <div className="flip-card-back rounded-4">
                          ...
                          <ul className="fs-12 ms-0 ps-3">
                            <li><a className="color-black" href="#">Dubai to Singapore - </a></li>
                            <li><a className="color-black" href="#">Abu Dhabi to Singapore - </a></li>
                            <li><a className="color-black" href="#">Sharjah to Singapore - </a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flip-card">
                      <div className="flip-card-inner">
                        ...
                        <div className="flip-card-back rounded-4">
                          ...
                          <ul className="fs-12 ms-0 ps-3">
                            <li><a className="color-black" href="#">Dubai to Thailand - </a></li>
                            <li><a className="color-black" href="#">Abu Dhabi to Thailand - </a></li>
                            <li><a className="color-black" href="#">Sharjah to Thailand - </a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flip-card">
                      <div className="flip-card-inner">
                        ...
                        <div className="flip-card-back rounded-4">
                          ...
                          <ul className="fs-12 ms-0 ps-3">
                            <li><a className="color-black" href="#">Dubai to USA - </a></li>
                            <li><a className="color-black" href="#">Abu Dhabi to USA - </a></li>
                            <li><a className="color-black" href="#">Sharjah to USA - </a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flip-card">
                      <div className="flip-card-inner">
                        ...
                        <div className="flip-card-back rounded-4">
                          ...
                          <ul className="fs-12 ms-0 ps-3">
                            <li><a className="color-black" href="#">Dubai to Canada - </a></li>
                            <li><a className="color-black" href="#">Abu Dhabi to Canada - </a></li>
                            <li><a className="color-black" href="#">Sharjah to Canada - </a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
