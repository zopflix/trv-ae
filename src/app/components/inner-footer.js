            ...
            <footer>
                <div className="container">
                    <div className="row">
                        ...
                        />
                        <div className="col-12">
                            <p className="text-center fs-12 border-top pt-3">Copyright © 2025 <a className="color-blue text-decoration-none fw-bold" href="https://www.travanya.ae/">Travanya.ae</a>, Powered by SHIPRA TRAVELS PVT. LTD. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
